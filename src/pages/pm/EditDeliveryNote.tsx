        ...
        <div className="p-6 bg-slate-50 min-h-screen">
            <div className="flex items-center justify-between mb-6 max-w-5xl mx-auto">
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate('/delivery-notes')} className="p-2 hover:bg-white rounded-full transition-colors" title="Back to Delivery Notes">
                        <ArrowLeft size={20} />
                    </button>
                    <div>
            ...
            <div className="max-w-5xl mx-auto space-y-8">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-6">
                    ...
                    <div className="pt-4 flex justify-end gap-3 border-t">
                        <button type="button" onClick={() => navigate('/delivery-notes')} className="px-6 py-2 border rounded-lg font-semibold hover:bg-slate-50 transition">
                            Cancel
                        </button>
                        <button 
                            type="submit" 
